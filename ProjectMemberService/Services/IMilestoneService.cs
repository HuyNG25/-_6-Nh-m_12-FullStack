...
namespace ProjectMemberService.Services
{
    public interface IMilestoneService
    {
        ...
        Task<ApiResponse<List<MilestoneResponseDto>>> GetAllAsync(Guid projectId);
        Task<ApiResponse<MilestoneResponseDto>> GetByIdAsync(Guid projectId, Guid milestoneId);
